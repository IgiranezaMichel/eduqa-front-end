...
export const HodManageLecturers=()=>{
    return <Navigation items={HodMenu}>
        <div className="float-end py-3 ">
            <button className="p-1 bg-green-800/80 text-white mx-2 hover:bg-blue-600"><Download/> Import lecturers</button>
            <button className="p-1 bg-blue-950/90 text-white  hover:bg-blue-600"><Add/> Add lectures</button>
        </div>
        <div className="flex items-center justify-between clear-both py-3">
            <section>
                ...
                <div className="text-gray-500 text-sm">
                    This table contains all the lecturers in the department 
               </div>
            </section>
            <section>
