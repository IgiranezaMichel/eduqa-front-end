import { Add, Close, ContactEmergency, Download, People, Person, Search } from "@mui/icons-material";
                                ...
                                <td colSpan={9}>
                                    <div className="flex border-t gap-4 items-center border-gray-200 bg-white px-4 py-3 sm:px-6">
                                            ...
                                            <div className="flex gap-3">
                                                <select onChange={e=>setPage({...page,pageSize:e.target.value})} className="border border-gray-300 rounded-md text-sm">
